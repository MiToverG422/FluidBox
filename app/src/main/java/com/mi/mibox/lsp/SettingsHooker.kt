...
object SettingsHooker {
    private const val MODULE_PACKAGE = "com.mi.mibox"
    ...
    private fun configureEntryPreference(preference: Any, context: Context, classLoader: ClassLoader) {
        ...
        runCatching { call(preference, "setIcon", moduleContext.getDrawable(R.drawable.ic_settings_mibox_hook)) }
    ...
    private fun addSwitch(
        ...
        call(preference, "setKey", "mibox_hook_${toggle.settingsKey}")
    ...
    private fun addAction(
        ...
        call(preference, "setKey", "mibox_hook_restart_systemui")
        call(preference, "setTitle", title)
        call(preference, "setSummary", summary)
    ...
    private fun log(message: String, throwable: Throwable? = null) {
        XposedBridge.log("MiBox SettingsHooker: $message${throwable?.let { "\n${it.stackTraceToString()}" } ?: ""}")
    }
